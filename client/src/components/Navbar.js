...
class Navbar extends Component {
    ...
    handleSearchSubmit = e => {
        e.preventDefault();
        console.log('search book ', this.state.searchBook)
                        ...
                        <ul className="navbar-nav ml-auto mr-3">
                            <li className="nav-item pr-2">
                                <form className="form-inline my-2 my-lg-0" onSubmit={this.handleSearchSubmit}>
                                    <input className="form-control mr-sm-2" onChange={this.handleSearch} type="search" placeholder="Search by title, author or ISBN " />
