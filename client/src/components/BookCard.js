    ...
    render() {
        ...
        return (
            <div className="col-lg-2 col-md-3 col-sm-4 col-6 mb-5">
                {book.image ? <img className=" w-100 mb-2 img-fluid" src={require(`../images/${book.image}`)} alt="Book Cover" /> : <img className=" w-100 mb-2 img-fluid card card-body" src={require(`../images/bookMonk.png`)} alt="Book Cover" />}
                <div >
